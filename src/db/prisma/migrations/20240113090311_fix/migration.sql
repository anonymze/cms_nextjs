/*
  ...
  - You are about to drop the column `article_id` on the `Article_I18n` table. All the data in the column will be lost.
  - You are about to drop the column `page_id` on the `Page_I18n` table. All the data in the column will be lost.
  - Added the required column `article` to the `Article_I18n` table without a default value. This is not possible if the table is not empty.
  - Added the required column `page` to the `Page_I18n` table without a default value. This is not possible if the table is not empty.
