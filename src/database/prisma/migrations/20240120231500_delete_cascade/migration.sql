...
CREATE TABLE "new_Page_I18n" (
    ...
    "subtitle" TEXT,
    CONSTRAINT "Page_I18n_page_fkey" FOREIGN KEY ("page") REFERENCES "Page" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Article_I18n" (
    ...
    "description" TEXT,
    "conclusion" TEXT,
    CONSTRAINT "Article_I18n_article_fkey" FOREIGN KEY ("article") REFERENCES "Article" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
