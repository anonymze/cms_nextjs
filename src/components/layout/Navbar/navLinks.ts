...
export const optionsNavigation = [
    { id: 1, name: 'Gestion des utilisateurs', href: '/gestion-utilisateur', initial: 'H', current: false },
    { id: 2, name: 'Documentation', href: '/documentation', initial: 'T', current: false },
  ] satisfies Array<{ id: number; name: string; href: __next_route_internal_types__.RouteImpl<string>; initial: string; current: boolean }>