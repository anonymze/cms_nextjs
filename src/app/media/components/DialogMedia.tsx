...
const DialogMedia: React.FC<PropsWithChildren & { showActionButton: boolean }> = ({ showActionButton = false}) => {
	...
	return (
		<>
			...
			{showActionButton && (<Button large onClick={() => dialogRef.current?.show()}><PlusCircleIcon className="h-6 w-6 mr-2" /> Ajouter votre premier média</Button>)}
		</>
	)
}
