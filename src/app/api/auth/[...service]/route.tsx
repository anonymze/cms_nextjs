...
import { responseGithubAuthLogic, verifyGithubEnvVariables } from "./_services/github";
import { NextRequest, NextResponse } from "next/server";
import { responseGoogleAuthLogic, verifyGoogleEnvVariables } from "./_services/google";
...
function verifyEnvVariablesAndReturnResponse(service: string, req: NextRequest) {
	// clerk
 ...
 * @throws {Error}
 */
export async function handleClerkLogicAndReturnResponse(
	req: NextRequest,
	email: string,
	name = "",
) {
